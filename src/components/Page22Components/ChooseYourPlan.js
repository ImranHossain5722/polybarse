        ...
        >
          <SwiperSlide>
            <div className="w-[280px] div relative border-1 border-[#373371] rounded-5 bg-[#0D0A3A] ">
              ...
              <div className="absolute -bottom-6 left-[90px] ">
                <button className=" flex items-center justify-center bg-[#373371] py-2 px-8 rounded-full">
          ...
          <SwiperSlide>
            <div className="w-[280px] div relative border-1 border-[#373371] rounded-5 bg-[#0D0A3A] ">
              ...
              <div className="absolute -bottom-6 left-[90px] ">
                <button className=" flex items-center justify-center gap-2 bg-[#373371] py-2 px-8 rounded-full">
