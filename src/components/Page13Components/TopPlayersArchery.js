    ...
    <div className="md:flex justify-between mt-20  ">
              ...
              <table className="table-auto w-[475px] md:w-full">
                ...
                <tbody className="text-sm  divide-[#0D0A3A]">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">2</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">3</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">4</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">5</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">6</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">7</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">8</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">9</div>
                      </div>
                    </td>
                    <td className="p-2 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
                  ...
                  <tr className=" bg-[#133568] h-10">
                    <td className="py-2 px-8 whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="flex items-center justify-center">
                        <div className="font-medium text-20 text-white">10</div>
                      </div>
                    </td>
                    <td className="py-2 px-8  whitespace-nowrap border-2 border-[#0D0A3A]">
                      <div className="text-center text-white text-20">
      ...
      <div className=" w-full md:w-[374px]  bg-[#0A264F] px-6 mt-4 md:mt-0 pb-3 md:pb-0 rounded-5">
        ...
        <div className="flex justify-center pt-10">
          <img className=" w-48 h-full " src="/images/big-cup.png" alt="coin" />
        </div>
