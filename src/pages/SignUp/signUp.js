...
const SignUp = () => {
  ...
  return (
    <div>
      ...
      {showPopUp ? (
        <>
          <div className="fixed top-0 bottom-0 left-0 right-0 z-50 flex justify-center">
            <section class="p-32">
...
"
                  ...
                  text-18 rounded-2xl text-sm px-5 py-2.5 text-center uppercase button-shrink font-semibold"
                      ...
                      <div className="flex justify-center items-center">
                        <div className="w-16 h-16 p-3 mr-3 border border-inputBorder rounded-lg  flex justify-center items-center mt-11 cursor-pointer button-shrink">
                          <a href="https://www.google.com/">
                            <img className="w-7 h-7" src={go} />
                          </a>
                        </div>
                        <div className="w-16 h-16 p-3 flex justify-center items-center border border-inputBorder rounded-lg mt-11 cursor-pointer button-shrink ">
                      ...
                      <div className="flex justify-around ">
                        <a href="#">
                          <div className=" p-3 border flex items-center  border-inputBorder rounded-lg mt-11 cursor-pointer button-shrink">
